...
l.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.ap;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.Oa}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);c=f?";domain="+f:"";g=g?";path="+g:"";d=d?";secure":"";h=0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString();this.h.cookie=a+"="+b+c+g+h+d+(null!=e?";samesite="+
e:"")};
...
;var bf={yo:"WEB_DISPLAY_MODE_UNKNOWN",uo:"WEB_DISPLAY_MODE_BROWSER",wo:"WEB_DISPLAY_MODE_MINIMAL_UI",xo:"WEB_DISPLAY_MODE_STANDALONE",vo:"WEB_DISPLAY_MODE_FULLSCREEN"};function cf(){this.data_=[];this.h=-1}
...
r(Eg,J);Eg.prototype.getKey=function(){return hd(this,1)};
Eg.prototype.getValue=function(){return hd(this,2===kd(this,Fg)?2:-1)};
Eg.prototype.setValue=function(a){return jd(this,2,Fg,a)};
var Fg=[2,3,4,5,6];function Gg(a){J.call(this,a)}
r(Gg,J);function Hg(a){J.call(this,a)}
r(Hg,J);function Ig(a){J.call(this,a,-1,Jg)}
r(Ig,J);Ig.prototype.getPlayerType=function(){return hd(this,36)};
...
r(Tg,J);Tg.prototype.getKey=function(){return pd(this,1)};
Tg.prototype.getValue=function(){return pd(this,2)};
...
r(Xg,J);Xg.prototype.getMessage=function(){return pd(this,1)};function Yg(a){J.call(this,a)}
...
r(rh,J);rh.prototype.getPlayerType=function(){var a=hd(this,7);return null==a?0:a};
rh.prototype.setVideoId=function(a){return D(this,19,a)};
function th(a,b){od(a,68,uh,b)}
function uh(a){J.call(this,a)}
r(uh,J);uh.prototype.getId=function(){return pd(this,2)};
...
r(Bh,J);function Ch(a){J.call(this,a)}
r(Ch,J);Ch.prototype.setVideoId=function(a){return jd(this,1,Dh,a)};
Ch.prototype.getPlaylistId=function(){return hd(this,2===kd(this,Dh)?2:-1)};
...
r(Hh,J);var Ih;Ih=new function(a,b){this.h=a;this.fieldName=b;this.isRepeated=0;this.i=wd}(406606992,{So:0},Hh);function Jh(){Hh.apply(this,arguments)}
...
;function si(a){var b=ti;a=void 0===a?z("yt.ads.biscotti.lastId_")||"":a;var c=Object,d=c.assign,e={};e.dt=Zd;e.flash="0";a:{try{var f=b.h.top.location.href}catch(ua){f=2;break a}f=f?f===b.i.location.href?0:1:2}e=(e.frm=f,e);try{e.u_tz=-(new Date).getTimezoneOffset();var g=void 0===g?Ad:g;try{var h=g.history.length}catch(ua){h=0}e.u_his=h;var k;e.u_h=null==(k=Ad.screen)?void 0:k.height;var m;e.u_w=null==(m=Ad.screen)?void 0:m.width;var q;e.u_ah=null==(q=Ad.screen)?void 0:q.availHeight;var u;e.u_aw=
...
"X-YouTube-Page-Label":"PAGE_BUILD_LABEL","X-YouTube-Variants-Checksum":"VARIANTS_CHECKSUM"},Ai="app debugcss debugjs expflag force_ad_params force_ad_encrypted force_viral_ad_response_params forced_experiments innertube_snapshots innertube_goldens internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address".split(" ").concat(fa(ae)),Wi=!1;
...
function Bj(a,b,c){a=a.vb;if("WEB"===a||"MWEB"===a||1===a||2===a)if(b){c=ld(b,Hg,96)||new Hg;var d=hj();d=Object.keys(bf).indexOf(d);d=-1===d?null:d;null!==d&&D(c,3,d);H(b,96,c)}else c&&(c.client.mainAppWebInfo=null!=(d=c.client.mainAppWebInfo)?d:{},c.client.mainAppWebInfo.webDisplayMode=hj())}
...
function Dj(a,b,c){if(a.appInstallData)if(b){var d;c=null!=(d=ld(b,Gg,62))?d:new Gg;D(c,6,a.appInstallData);H(b,62,c)}else c&&(c.client.configInfo=c.client.configInfo||{},c.client.configInfo.appInstallData=a.appInstallData)}
...
function Gj(a,b,c){c=void 0===c?{}:c;var d={};M("enable_web_eom_visitor_data")&&A("EOM_VISITOR_DATA")?d={"X-Goog-EOM-Visitor-Id":A("EOM_VISITOR_DATA")}:d={"X-Goog-Visitor-Id":c.visitorData||A("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.No||A("AUTHORIZATION"))||(a?b="Bearer "+z("gapi.auth.getToken")().Mo:b=me([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=A("SESSION_INDEX",0),M("pageid_as_header_web")&&(d["X-Goog-PageId"]=A("DELEGATED_SESSION_ID")));return d}
...
function bo(a,b){var c=Kn();c&&c.publish.apply(c,arguments)}
function Bo(a){var b=Kn();if(b)if(b.clear(a),a)Co(a);else for(var c in Hn)Co(c)}
...
function Wo(a,b){if("log_event"===a.endpoint){var c=Po(a,!0),d=new Map;d.set(c,[a.payload.toJSON()]);b&&(Fo=new b);return new Wf(function(e){Fo&&Fo.isReady()?Xo(d,e,{bypassNetworkless:!0},!0):e()})}}
function Po(a,b){var c="";if(a.va)c="visitorOnlyApprovedKey";else if(a.cttAuthInfo){if(void 0===b?0:b){b=a.cttAuthInfo.token;c=a.cttAuthInfo;var d=new Ch;c.videoId?d.setVideoId(c.videoId):c.playlistId&&jd(d,2,Dh,c.playlistId);No[b]=d}else b=a.cttAuthInfo,c={},b.videoId?c.videoId=b.videoId:b.playlistId&&(c.playlistId=b.playlistId),Mo[a.cttAuthInfo.token]=c;c=a.cttAuthInfo.token}return c}
...
g||b()},d));
Jo=!1}}
function Xo(a,b,c,d){var e=Fo;c=void 0===c?{}:c;var f=Math.round(P()),g=a.size;a=p(a);for(var h=a.next();!h.done;h=a.next()){var k=p(h.value);h=k.next().value;var m=k=k.next().value;k=new Eh;var q=Fj(e.config_||zj());H(k,1,q);m=bp(m);for(q=0;q<m.length;q++)od(k,3,yh,m[q]);(m=No[h])&&cp(k,h,m);delete No[h];h="visitorOnlyApprovedKey"===h;dp(k,f,h);$o(c);a:{Uc=!0;try{var u=JSON.stringify(k.toJSON(),td);break a}finally{Uc=!1}u=void 0}k=u;h=ap(c,h,function(){g--;g||b()},function(){g--;
g||b()},d);
...
function ap(a,b,c,d,e){return{retry:!0,onSuccess:c,onError:d,Ab:a,va:b,Po:!!e,headers:{},postBodyFormat:"",postBody:""}}
...
function cp(a,b,c){if(hd(c,1===kd(c,Dh)?1:-1))var d=1;else if(c.getPlaylistId())d=2;else return;H(a,4,c);a=ld(a,Pg,1)||new Pg;c=ld(a,Ng,3)||new Ng;var e=new Mg;e.setToken(b);D(e,1,d);od(c,12,Mg,e);H(a,3,c)}
function bp(a){for(var b=[],c=0;c<a.length;c++)try{b.push(new yh(a[c]))}catch(d){di(new Q("Transport failed to deserialize "+String(a[c])))}return b}
...
;function xp(a,b,c){var d=new yh;nd(d,73,zh,a);c?vp(d,c,b):wp(d,b)}
function yp(a,b,c){var d=new yh;nd(d,78,zh,a);c?vp(d,c,b):wp(d,b)}
function zp(a,b,c){var d=new yh;nd(d,208,zh,a);c?vp(d,c,b):wp(d,b)}
function Ap(a,b,c){var d=new yh;nd(d,156,zh,a);c?vp(d,c,b):wp(d,b)}
function Bp(a,b,c){var d=new yh;nd(d,215,zh,a);c?vp(d,c,b):wp(d,b)}
function Cp(a,b,c){var d=new yh;nd(d,111,zh,a);c?vp(d,c,b):wp(d,b)}
...
":"+Da);if("IGNORED"===a.level)var ua=0;else a:{for(var Mn=np(),Nn=p(Mn.ha),Bi=Nn.next();!Bi.done;Bi=Nn.next()){var On=Bi.value;if(G.message&&G.message.match(On.Uo)){ua=On.weight;break a}}for(var Pn=p(Mn.ga),Ci=Pn.next();!Ci.done;Ci=Pn.next()){var Qn=Ci.value;if(Qn.ka(G)){ua=Qn.weight;break a}}ua=1}G.sampleWeight=ua;for(var Rn=p(ip),Di=Rn.next();!Di.done;Di=Rn.next()){var Ei=Di.value;if(Ei.Pa[G.name])for(var Sn=p(Ei.Pa[G.name]),Fi=Sn.next();!Fi.done;Fi=Sn.next()){var Tn=Fi.value,Nf=G.message.match(Tn.regexp);
if(Nf){G.params["params.error.original"]=Nf[0];for(var Gi=Tn.groups,Un={},Xc=0;Xc<Gi.length;Xc++)Un[Gi[Xc]]=Nf[Xc+1],G.params["params.error."+Gi[Xc]]=Nf[Xc+1];G.message=Ei.eb(Un);break}}}G.params||(G.params={});var Vn=np();G.params["params.errorServiceSignature"]="msg="+Vn.ha.length+"&cb="+Vn.ga.length;G.params["params.serviceWorker"]="false";x.document&&x.document.querySelectorAll&&(G.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));Cb("sample").constructor!==
Ab&&(G.params["params.fconst"]="true");window.yterr&&"function"===typeof window.yterr&&window.yterr(G);if(0!==G.sampleWeight&&!Dp.has(G.message)){if("ERROR"===h){op.ja("handleError",G);if(M("record_app_crashed_web")&&0===Gp&&1===G.sampleWeight)if(Gp++,M("errors_via_jspb")){var Hi=new bh;D(Hi,1,1);if(!M("report_client_error_with_app_crash_ks")){var Wn=new Xg;D(Wn,1,G.message);var Xn=new Yg;H(Xn,3,Wn);var Yn=new Zg;H(Yn,5,Xn);var Zn=new $g;H(Zn,9,Yn);H(Hi,4,Zn)}var $n=new yh;nd($n,20,zh,Hi);wp($n)}else{var ao=
{appCrashType:"APP_CRASH_TYPE_BREAKPAD"};M("report_client_error_with_app_crash_ks")||(ao.systemHealth={crashData:{clientError:{logMessage:{message:G.message}}}});hk("appCrashed",ao)}Fp++}else"WARNING"===h&&op.ja("handleWarning",G);if(M("kevlar_gel_error_routing"))a:{var Vd=h;if(M("errors_via_jspb")){if(Lp())var co=void 0;else{var Yc=new Ug;D(Yc,1,G.stack);G.fileName&&D(Yc,4,G.fileName);var qb=G.lineNumber&&G.lineNumber.split?G.lineNumber.split(":"):[];0!==qb.length&&(1!==qb.length||isNaN(Number(qb[0]))?
2!==qb.length||isNaN(Number(qb[0]))||isNaN(Number(qb[1]))||(D(Yc,2,Number(qb[0])),D(Yc,3,Number(qb[1]))):D(Yc,2,Number(qb[0])));var kc=new Xg;D(kc,1,G.message);D(kc,3,G.name);D(kc,6,G.sampleWeight);"ERROR"===Vd?D(kc,2,2):"WARNING"===Vd?D(kc,2,1):D(kc,2,0);var Ii=new Vg;D(Ii,1,!0);nd(Ii,3,Wg,Yc);var Jb=new Rg;D(Jb,3,window.location.href);for(var eo=A("FEXP_EXPERIMENTS",[]),Ji=0;Ji<eo.length;Ji++){var wt=eo[Ji];Wc(Jb);id(Jb,5).push(wt)}var Ki=A("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(!Wh()&&Ki)for(var fo=
p(Object.keys(Ki)),lc=fo.next();!lc.done;lc=fo.next()){var go=lc.value,Li=new Tg;D(Li,1,go);Li.setValue(String(Ki[go]));od(Jb,4,Tg,Li)}var Mi=G.params;if(Mi){var ho=p(Object.keys(Mi));for(lc=ho.next();!lc.done;lc=ho.next()){var io=lc.value,Ni=new Tg;D(Ni,1,"client."+io);Ni.setValue(String(Mi[io]));od(Jb,4,Tg,Ni)}}var jo=A("SERVER_NAME"),ko=A("SERVER_VERSION");if(jo&&ko){var Oi=new Tg;D(Oi,1,"server.name");Oi.setValue(jo);od(Jb,4,Tg,Oi);var Pi=new Tg;D(Pi,1,"server.version");Pi.setValue(ko);od(Jb,
4,Tg,Pi)}var Of=new Yg;H(Of,1,Jb);H(Of,2,Ii);H(Of,3,kc);co=Of}var lo=co;if(!lo)break a;var mo=new yh;nd(mo,163,zh,lo);wp(mo)}else{if(Lp())var no=void 0;else{var Wd={stackTrace:G.stack};G.fileName&&(Wd.filename=G.fileName);var rb=G.lineNumber&&G.lineNumber.split?G.lineNumber.split(":"):[];0!==rb.length&&(1!==rb.length||isNaN(Number(rb[0]))?2!==rb.length||isNaN(Number(rb[0]))||isNaN(Number(rb[1]))||(Wd.lineNumber=Number(rb[0]),Wd.columnNumber=Number(rb[1])):Wd.lineNumber=Number(rb[0]));var Qi={level:"ERROR_LEVEL_UNKNOWN",
message:G.message,errorClassName:G.name,sampleWeight:G.sampleWeight};"ERROR"===Vd?Qi.level="ERROR_LEVEL_ERROR":"WARNING"===Vd&&(Qi.level="ERROR_LEVEL_WARNNING");var xt={isObfuscated:!0,browserStackInfo:Wd},Zc={pageUrl:window.location.href,kvPairs:[]};A("FEXP_EXPERIMENTS")&&(Zc.experimentIds=A("FEXP_EXPERIMENTS"));var Ri=A("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(!Wh()&&Ri)for(var oo=p(Object.keys(Ri)),mc=oo.next();!mc.done;mc=oo.next()){var po=mc.value;Zc.kvPairs.push({key:po,value:String(Ri[po])})}var Si=
G.params;if(Si){var qo=p(Object.keys(Si));for(mc=qo.next();!mc.done;mc=qo.next()){var ro=mc.value;Zc.kvPairs.push({key:"client."+ro,value:String(Si[ro])})}}var so=A("SERVER_NAME"),to=A("SERVER_VERSION");so&&to&&(Zc.kvPairs.push({key:"server.name",value:so}),Zc.kvPairs.push({key:"server.version",value:to}));no={errorMetadata:Zc,stackTrace:xt,logMessage:Qi}}var uo=no;if(!uo)break a;hk("clientError",uo)}("ERROR"===Vd||M("errors_flush_gel_always_killswitch"))&&So(void 0,void 0,!1)}if(!M("suppress_error_204_logging")){var Xd=
G.params||{},Kb={urlParams:{a:"logerror",t:"jserror",type:G.name,msg:G.message.substr(0,250),line:G.lineNumber,level:h,"client.name":Xd.name},postParams:{url:A("PAGE_NAME",window.location.href),file:G.fileName},method:"POST"};Xd.version&&(Kb["client.version"]=Xd.version);if(Kb.postParams){G.stack&&(Kb.postParams.stack=G.stack);for(var vo=p(Object.keys(Xd)),Ti=vo.next();!Ti.done;Ti=vo.next()){var wo=Ti.value;Kb.postParams["client."+wo]=Xd[wo]}var Ui=A("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(Ui)for(var xo=
p(Object.keys(Ui)),Vi=xo.next();!Vi.done;Vi=xo.next()){var yo=Vi.value;Kb.postParams[yo]=Ui[yo]}var zo=A("SERVER_NAME"),Ao=A("SERVER_VERSION");zo&&Ao&&(Kb.postParams["server.name"]=zo,Kb.postParams["server.version"]=Ao)}Zi(A("ECATCHER_REPORT_HOST","")+"/error_204",Kb)}try{Dp.add(G.message)}catch(Xu){}Ep++}}}}
function Lp(){for(var a=p(Ip),b=a.next();!b.done;b=a.next())if(Yj(b.value.toLowerCase()))return!0;return!1}
function Mp(a){var b=Ja.apply(1,arguments);a.args||(a.args=[]);a.args.push.apply(a.args,fa(b))}
;function Np(){this.register=new Map}
function Op(a){a=p(a.register.values());for(var b=a.next();!b.done;b=a.next())b.value.Xo("ABORTED")}
...
return a.join("")}
;var Sp=x.ytLoggingDocDocumentNonce_;Sp||(Sp=Rp(),y("ytLoggingDocDocumentNonce_",Sp));var Tp=Sp;var Up={Bg:0,qd:1,Ad:2,fk:3,Dg:4,mo:5,Vk:6,wm:7,Yl:8,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE",8:"PUSH_NOTIFICATIONS"};function Vp(a){this.h=a}
...
Wm:106442,Xm:134840,Ym:63667,Zm:63668,an:63669,bn:130686,cn:147036,dn:78314,en:147799,fn:148649,gn:55761,hn:127098,jn:134841,kn:96368,ln:67374,mn:48992,nn:146176,pn:49956,qn:31961,rn:26388,sn:23811,tn:5E4,un:126250,vn:96370,wn:47355,xn:47356,yn:37935,zn:45521,An:21760,Bn:83769,Cn:49977,Dn:49974,En:93497,Fn:93498,Gn:34325,Hn:140759,In:115803,Jn:123707,Kn:100081,Ln:35309,Mn:68314,Nn:25602,On:100339,Pn:143516,Qn:59018,Rn:18248,Sn:50625,Tn:9729,Un:37168,Vn:37169,Wn:21667,Xn:16749,Yn:18635,Zn:39305,ao:18046,
bo:53969,co:8213,eo:93926,fo:102852,ho:110099,jo:22678,ko:69076,lo:137575,no:139224,oo:100856,po:17736,qo:3832,ro:147111,so:55759,to:64031,zo:93044,Ao:93045,Bo:34388,Co:17657,Do:17655,Eo:39579,Fo:39578,Go:77448,Ho:8196,Io:11357,Jo:69877,Ko:8197,Lo:82039};function iq(){var a=ub(jq),b;return cg(new Wf(function(c,d){a.onSuccess=function(e){wi(e)?c(new kq(e)):d(new lq("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
Yq.prototype.i=function(){};var Zq={},$q=(Zq.GET_DATASYNC_IDS=Sq(Yq),Zq);function ar(a){var b=Ja.apply(1,arguments);if(!br(a)||b.some(function(d){return!br(d)}))throw Error("Only objects may be merged.");
b=p(b);for(var c=b.next();!c.done;c=b.next())cr(a,c.value);return a}
...
W[W.LATENCY_ACTION_STARTUP]="LATENCY_ACTION_STARTUP";W[W.LATENCY_ACTION_UNKNOWN]="LATENCY_ACTION_UNKNOWN";var Ir={LATENCY_NETWORK_MOBILE:2,LATENCY_NETWORK_WIFI:1,LATENCY_NETWORK_UNKNOWN:0};Ir[Ir.LATENCY_NETWORK_MOBILE]="LATENCY_NETWORK_MOBILE";Ir[Ir.LATENCY_NETWORK_WIFI]="LATENCY_NETWORK_WIFI";Ir[Ir.LATENCY_NETWORK_UNKNOWN]="LATENCY_NETWORK_UNKNOWN";
...
Sr.prototype.tick=function(a,b,c,d){Ur(this,"tick_"+a+"_"+b)||(c={timestamp:c,cttAuthInfo:d},M("web_csi_via_jspb")?(d=new vh,D(d,1,a),D(d,2,b),a=new yh,nd(a,5,zh,d),wp(a,c)):hk("latencyActionTicked",{tickName:a,clientActionNonce:b},c))};
...
Sr.prototype.jspbInfo=function(a,b,c){for(var d="",e=0;e<a.toJSON().length;e++)void 0!==a.toJSON()[e]&&(d=0===e?d.concat(""+e):d.concat("_"+e));Ur(this,"info_"+d+"_"+b)||(D(a,2,b),b={cttAuthInfo:c},c=new yh,nd(c,7,zh,a),wp(c,b))};
...
X:b};d=p(d);for(var g=d.next();!g.done;g=d.next())g=g.value.getAsJson(),(ob(g)||!g.trackingParams&&!g.veType)&&Kp(Error("Child VE logged with no data"));if(M("il_via_jspb")){var h=new jh;h.S(b);lh(h,c.getAsJspb());gb(e,function(k){k=k.getAsJspb();od(h,3,dh,k)});
...
function kt(a,b,c){c=void 0===c?null:c;var d=lt(a),e=document.getElementById(d),f=e&&et(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=Jn(d,b),b=""+Ra(b),mt[b]=f),g||(e=nt(a,d,function(){et(e,"loaded")||(ct(e),bo(d),xi(Xa(Bo,d),0))},c)))}
...
function ot(a){a=lt(a);var b=document.getElementById(a);b&&(Bo(a),b.parentNode.removeChild(b))}
...
var Nt;r(Mt,Lt);Mt.prototype.l=function(){if(M("web_fp_via_jspb")){var a=new ch,b=bq();b&&a.S(b);b=new yh;nd(b,380,zh,a);wp(b);M("web_fp_via_jspb_and_json")&&hk("finalPayload",{csn:bq()})}else hk("finalPayload",{csn:bq()})};
...
function nu(a){var b=ou(a),c=document.getElementById(b),d=c&&et(c,"loaded");d||c&&!d||(c=pu(a,b,function(){et(c,"loaded")||(ct(c),bo(b),xi(Xa(Bo,b),0))}))}
...
function uu(a){a.addEventListener("WATCH_LATER_VIDEO_ADDED",function(b){bo("WATCH_LATER_VIDEO_ADDED",b)});
a.addEventListener("WATCH_LATER_VIDEO_REMOVED",function(b){bo("WATCH_LATER_VIDEO_REMOVED",b)})}
