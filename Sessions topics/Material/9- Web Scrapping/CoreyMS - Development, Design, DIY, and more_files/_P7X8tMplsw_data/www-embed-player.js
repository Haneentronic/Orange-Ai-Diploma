...
;function bd(a){switch(typeof a){case "number":return isFinite(a)?a:String(a);case "object":if(a&&!Array.isArray(a)&&Lc&&null!=a&&a instanceof Uint8Array)return Kc(a)}return a}
...
function dd(a){return Lc&&null!=a&&a instanceof Uint8Array?new Uint8Array(a):a}
...
qd.prototype.clone=function(){var a=cd(this.G);rd=a;a=new this.constructor(a);rd=null;sd(a,this);return a};
qd.prototype.isMutable=function(a){if(a!==Mc)throw Error("requires a valid immutable API token");return!Rc(this.G)};
qd.prototype.toString=function(){return this.G.toString()};
function td(a,b){return bd(b)}
function sd(a,b){b.o&&(a.o=b.o.slice());var c=b.h;if(c){b=b.i;for(var d in c){var e=c[d];if(e){var f=!(!b||!b[d]),g=+d;if(Array.isArray(e)){if(e.length)for(f=md(a,e[0].constructor,g,f),g=0;g<Math.min(f.length,e.length);g++)sd(f[g],e[g])}else(f=ld(a,e.constructor,g,void 0,f))&&sd(f,e)}}}}
var rd;function ud(){qd.apply(this,arguments)}
r(ud,qd);if($c){var vd={};Object.defineProperties(ud,(vd[Symbol.hasInstance]=ad(function(){throw Error("Cannot perform instanceof checks for MutableMessage");}),vd))};function wd(a,b){var c=this.h;if(this.isRepeated){var d=!0;d=void 0===d?!1:d;Wc(a);if(b){var e=Qc([]);for(var f=0;f<b.length;f++)e[f]=b[f].G;a.h||(a.h={});a.h[c]=b}else a.h&&(a.h[c]=void 0),e=Vc;a=D(a,c,e,d)}else a=H(a,c,b,!0);return a}
;function J(){ud.apply(this,arguments)}
r(J,ud);if($c){var xd={};Object.defineProperties(J,(xd[Symbol.hasInstance]=ad(Object[Symbol.hasInstance]),xd))};function yd(){var a=this;this.promise=new Promise(function(b,c){a.resolve=b;a.reject=c})}
...
var Ud=[Td("data"),Td("http"),Td("https"),Td("mailto"),Td("ftp"),new Sd(function(a){return/^[^:]*([/?#]|$)/.test(a)})];function Yd(a){"number"==typeof a&&(a=Math.round(a)+"px");return a}
...
;function ne(a){if($c){var b={};Object.defineProperties(a,(b[Symbol.hasInstance]=ad(Object[Symbol.hasInstance]),b))}}
...
;var bf={Ao:"WEB_DISPLAY_MODE_UNKNOWN",wo:"WEB_DISPLAY_MODE_BROWSER",yo:"WEB_DISPLAY_MODE_MINIMAL_UI",zo:"WEB_DISPLAY_MODE_STANDALONE",xo:"WEB_DISPLAY_MODE_FULLSCREEN"};function cf(){this.data_=[];this.h=-1}
...
var Yf=new ef(function(){return new Xf},function(a){a.reset()});
...
function fg(a,b,c,d){if(3==c&&b.onRejected&&!b.j)for(;a&&a.o;a=a.j)a.o=!1;if(b.h)b.h.j=null,kg(b,c,d);else try{b.j?b.i.call(b.context):kg(b,c,d)}catch(e){lg.call(null,e)}ff(Yf,b)}
...
var lg=jf;function cg(a){$a.call(this,a)}
...
r(Dg,J);Dg.prototype.getKey=function(){return hd(this,1)};
Dg.prototype.getValue=function(){return hd(this,2===kd(this,Eg)?2:-1)};
Dg.prototype.setValue=function(a){return jd(this,2,Eg,a)};
var Eg=[2,3,4,5,6];function Fg(a){J.call(this,a)}
r(Fg,J);function Gg(a){J.call(this,a)}
r(Gg,J);function Hg(a){J.call(this,a,-1,Ig)}
r(Hg,J);Hg.prototype.getPlayerType=function(){return hd(this,36)};
...
r(Sg,J);Sg.prototype.getKey=function(){return pd(this,1)};
Sg.prototype.getValue=function(){return pd(this,2)};
...
r(Ug,J);var Vg=[2,3];function Wg(a){J.call(this,a)}
r(Wg,J);Wg.prototype.getMessage=function(){return pd(this,1)};function Xg(a){J.call(this,a)}
...
qh.prototype.getPlayerType=function(){var a=hd(this,7);return null==a?0:a};
qh.prototype.setVideoId=function(a){return D(this,19,a)};
function th(a,b){return D(a,25,b)}
function uh(a,b){od(a,68,vh,b)}
function vh(a){J.call(this,a)}
r(vh,J);vh.prototype.getId=function(){return pd(this,2)};
...
r(Ch,J);function Dh(a){J.call(this,a)}
r(Dh,J);Dh.prototype.setVideoId=function(a){return jd(this,1,Eh,a)};
Dh.prototype.getPlaylistId=function(){return hd(this,2===kd(this,Eh)?2:-1)};
...
r(Ih,J);var Jh;Jh=new function(a,b){this.h=a;this.fieldName=b;this.isRepeated=0;this.i=wd}(406606992,{Uo:0},Ih);function Kh(){Ih.apply(this,arguments)}
r(Kh,Ih);ne(Kh);function Lh(a,b){1<b.length?a[b[0]]=b[1]:1===b.length&&Object.assign(a,b[0])}
...
r(Sh,Hh);ne(Sh);var Th=new Sh(Rh),Uh=Ph.EXPERIMENT_FLAGS;if(!Uh||!Uh.jspb_i18n_extension){var Vh=new Kh;Jh.i(Th,Vh)}y("yt.config_",Ph);y("yt.configJspb_",Rh);function Wh(){Lh(Ph,arguments)}
...
;function ti(a){var b=ui;a=void 0===a?z("yt.ads.biscotti.lastId_")||"":a;var c=Object,d=c.assign,e={};e.dt=Zd;e.flash="0";a:{try{var f=b.h.top.location.href}catch(ua){f=2;break a}f=f?f===b.i.location.href?0:1:2}e=(e.frm=f,e);try{e.u_tz=-(new Date).getTimezoneOffset();var g=void 0===g?Ad:g;try{var h=g.history.length}catch(ua){h=0}e.u_his=h;var k;e.u_h=null==(k=Ad.screen)?void 0:k.height;var m;e.u_w=null==(m=Ad.screen)?void 0:m.width;var q;e.u_ah=null==(q=Ad.screen)?void 0:q.availHeight;var u;e.u_aw=
...
"X-YouTube-Page-Label":"PAGE_BUILD_LABEL","X-YouTube-Variants-Checksum":"VARIANTS_CHECKSUM"},Wi="app debugcss debugjs expflag force_ad_params force_ad_encrypted force_viral_ad_response_params forced_experiments innertube_snapshots innertube_goldens internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address".split(" ").concat(fa(ae)),Xi=!1;
...
;function jj(a,b,c,d,e){ie.set(""+a,b,{Oa:c,path:"/",domain:void 0===d?"youtube.com":d,secure:void 0===e?!1:e})}
function kj(a){return ie.get(""+a,void 0)}
function lj(){if(!ie.isEnabled())return!1;if(!ie.isEmpty())return!0;ie.set("TESTCOOKIESENABLED","1",{Oa:60});if("1"!==ie.get("TESTCOOKIESENABLED"))return!1;ie.remove("TESTCOOKIESENABLED");return!0}
...
function Cj(a,b,c){a=a.vb;if("WEB"===a||"MWEB"===a||1===a||2===a)if(b){c=ld(b,Gg,96)||new Gg;var d=ij();d=Object.keys(bf).indexOf(d);d=-1===d?null:d;null!==d&&D(c,3,d);H(b,96,c)}else c&&(c.client.mainAppWebInfo=null!=(d=c.client.mainAppWebInfo)?d:{},c.client.mainAppWebInfo.webDisplayMode=ij())}
...
function Ej(a,b,c){if(a.appInstallData)if(b){var d;c=null!=(d=ld(b,Fg,62))?d:new Fg;D(c,6,a.appInstallData);H(b,62,c)}else c&&(c.client.configInfo=c.client.configInfo||{},c.client.configInfo.appInstallData=a.appInstallData)}
...
function Hj(a,b,c){c=void 0===c?{}:c;var d={};M("enable_web_eom_visitor_data")&&A("EOM_VISITOR_DATA")?d={"X-Goog-EOM-Visitor-Id":A("EOM_VISITOR_DATA")}:d={"X-Goog-Visitor-Id":c.visitorData||A("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Po||A("AUTHORIZATION"))||(a?b="Bearer "+z("gapi.auth.getToken")().Oo:b=me([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=A("SESSION_INDEX",0),M("pageid_as_header_web")&&(d["X-Goog-PageId"]=A("DELEGATED_SESSION_ID")));return d}
;function Ij(a){a=Object.assign({},a);delete a.Authorization;var b=me();if(b){var c=new wf;c.update(A("INNERTUBE_API_KEY"));c.update(b);a.hash=Kc(c.digest(),3)}return a}
...
Wj.prototype.pause=function(){var a=z("yt.scheduler.instance.pause");a&&a()};var af=Xj();var Yj=Fc||Gc;function Zj(a){var b=Qb();return b?0<=b.toLowerCase().indexOf(a):!1}
...
;var Dm=Zh("network_polling_interval",3E4);function Em(){Ue.call(this);var a=this;this.T=0;this.A=this.m=!1;this.j=this.Za();M("use_shared_nsm")?(this.i=$e(),M("use_shared_nsm_and_keep_yt_online_updated")&&(this.i.W("networkstatus-online",function(){a.j=!0;a.A&&Cm()}),this.i.W("networkstatus-offline",function(){a.j=!1}))):(Fm(this),Gm(this))}
r(Em,Ue);function Hm(){if(!Em.h){var a=z("yt.networkStatusManager.instance")||new Em;y("yt.networkStatusManager.instance",a);Em.h=a}return Em.h}
...
l.ea=function(a){var b=this;if(M("use_shared_nsm")&&this.i){var c=Ye(this.i,a);c.then(function(d){M("use_cfr_monitor")&&ym().requestComplete("generate_204",d)});
...
signal:g}),5);case 5:h=!0;case 3:za(k);M("use_cfr_monitor")&&ym().requestComplete("generate_204",h);b.u=void 0;b.M&&af.U(b.M);h!==b.j&&(b.j=h,b.j&&b.m?Ve(b,"ytnetworkstatus-online"):b.m&&Ve(b,"ytnetworkstatus-offline"));d(h);Aa(k);break;case 2:ya(k),h=!1,k.s(3)}})})};
...
function(){Km(b,"publicytnetworkstatus-online")}),c(this.m,function(){Km(b,"publicytnetworkstatus-offline")})):(c(this.u,function(){Ve(b,"publicytnetworkstatus-online")}),c(this.m,function(){Ve(b,"publicytnetworkstatus-offline")}))}
r(Jm,Ue);Jm.prototype.H=function(){var a=z("yt.networkStatusManager.instance.isNetworkAvailable");return a?a.bind(this.i)():!0};
...
b=void 0===b?{}:b;M("skip_is_supported_killswitch")?ul().then(function(d){c(d)}):c(tl())}
function an(){var a=tl();if(!a)throw Ak("throttleSend");Um||(Um=af.N(function(){var b;return w(function(c){if(1==c.h)return t(c,im("NEW",a),2);if(3!=c.h)return b=c.i,b?t(c,gn(b),3):(bn(),c.return());Um&&(Um=0,an());c.h=0})},100))}
function bn(){af.U(Um);Um=0}
...
function Zm(){var a=tl();if(!a)throw Ak("retryQueuedRequests");im("QUEUED",a).then(function(b){b&&!jn(b,12E4)?af.N(function(){return w(function(c){if(1==c.h)return void 0===b.id?c.s(2):t(c,km(b.id,a),2);Zm();c.h=0})}):$m().H()&&an()})}
...
function xn(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=vn(a,b,c,d);if(e)return e;e=++un.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(h){h=new sn(h);if(!Ld(h.relatedTarget,function(k){return k==a}))return h.currentTarget=a,h.type=b,c.call(a,h)}:function(h){h=new sn(h);
...
Ya(An,K);An.prototype.Y=function(a){void 0===a.h&&tn(a);var b=a.h;void 0===a.i&&tn(a);this.i=new Hd(b,a.i)};
...
function En(a,b){Bn[a]||(Bn[a]=!0,af.N(function(){Dn();Bn[a]=!1},b))}
...
function Qo(a,b){var c="";if(a.va)c="visitorOnlyApprovedKey";else if(a.cttAuthInfo){if(void 0===b?0:b){b=a.cttAuthInfo.token;c=a.cttAuthInfo;var d=new Dh;c.videoId?d.setVideoId(c.videoId):c.playlistId&&jd(d,2,Eh,c.playlistId);Oo[b]=d}else b=a.cttAuthInfo,c={},b.videoId?c.videoId=b.videoId:b.playlistId&&(c.playlistId=b.playlistId),No[a.cttAuthInfo.token]=c;c=a.cttAuthInfo.token}return c}
...
g||b()},d));
Ko=!1}}
function Yo(a,b,c,d){var e=Go;c=void 0===c?{}:c;var f=Math.round(P()),g=a.size;a=p(a);for(var h=a.next();!h.done;h=a.next()){var k=p(h.value);h=k.next().value;var m=k=k.next().value;k=new Fh;var q=Gj(e.config_||Aj());H(k,1,q);m=cp(m);for(q=0;q<m.length;q++)od(k,3,zh,m[q]);(m=Oo[h])&&dp(k,h,m);delete Oo[h];h="visitorOnlyApprovedKey"===h;ep(k,f,h);ap(c);a:{Uc=!0;try{var u=JSON.stringify(k.toJSON(),td);break a}finally{Uc=!1}u=void 0}k=u;h=bp(c,h,function(){g--;g||b()},function(){g--;
g||b()},d);
...
function dp(a,b,c){if(hd(c,1===kd(c,Eh)?1:-1))var d=1;else if(c.getPlaylistId())d=2;else return;H(a,4,c);a=ld(a,Og,1)||new Og;c=ld(a,Mg,3)||new Mg;var e=new Lg;e.setToken(b);D(e,1,d);od(c,12,Lg,e);H(a,3,c)}
...
;function yp(a,b,c){var d=new zh;nd(d,73,Ah,a);c?wp(d,c,b):xp(d,b)}
function zp(a,b,c){var d=new zh;nd(d,78,Ah,a);c?wp(d,c,b):xp(d,b)}
function Ap(a,b,c){var d=new zh;nd(d,208,Ah,a);c?wp(d,c,b):xp(d,b)}
function Bp(a,b,c){var d=new zh;nd(d,156,Ah,a);c?wp(d,c,b):xp(d,b)}
function Cp(a,b,c){var d=new zh;nd(d,215,Ah,a);c?wp(d,c,b):xp(d,b)}
function Dp(a,b,c){var d=new zh;nd(d,111,Ah,a);c?wp(d,c,b):xp(d,b)}
...
2!==qb.length||isNaN(Number(qb[0]))||isNaN(Number(qb[1]))||(D(Yc,2,Number(qb[0])),D(Yc,3,Number(qb[1]))):D(Yc,2,Number(qb[0])));var kc=new Wg;D(kc,1,G.message);D(kc,3,G.name);D(kc,6,G.sampleWeight);"ERROR"===Vd?D(kc,2,2):"WARNING"===Vd?D(kc,2,1):D(kc,2,0);var Hi=new Ug;D(Hi,1,!0);nd(Hi,3,Vg,Yc);var Jb=new Qg;D(Jb,3,window.location.href);for(var fo=A("FEXP_EXPERIMENTS",[]),Ii=0;Ii<fo.length;Ii++){var xt=fo[Ii];Wc(Jb);id(Jb,5).push(xt)}var Ji=A("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(!Xh()&&Ji)for(var go=
p(Object.keys(Ji)),lc=go.next();!lc.done;lc=go.next()){var ho=lc.value,Ki=new Sg;D(Ki,1,ho);Ki.setValue(String(Ji[ho]));od(Jb,4,Sg,Ki)}var Li=G.params;if(Li){var io=p(Object.keys(Li));for(lc=io.next();!lc.done;lc=io.next()){var jo=lc.value,Mi=new Sg;D(Mi,1,"client."+jo);Mi.setValue(String(Li[jo]));od(Jb,4,Sg,Mi)}}var ko=A("SERVER_NAME"),lo=A("SERVER_VERSION");if(ko&&lo){var Ni=new Sg;D(Ni,1,"server.name");Ni.setValue(ko);od(Jb,4,Sg,Ni);var Oi=new Sg;D(Oi,1,"server.version");Oi.setValue(lo);od(Jb,
4,Sg,Oi)}var Of=new Xg;H(Of,1,Jb);H(Of,2,Hi);H(Of,3,kc);eo=Of}var mo=eo;if(!mo)break a;var no=new zh;nd(no,163,Ah,mo);xp(no)}else{if(Mp())var oo=void 0;else{var Wd={stackTrace:G.stack};G.fileName&&(Wd.filename=G.fileName);var rb=G.lineNumber&&G.lineNumber.split?G.lineNumber.split(":"):[];0!==rb.length&&(1!==rb.length||isNaN(Number(rb[0]))?2!==rb.length||isNaN(Number(rb[0]))||isNaN(Number(rb[1]))||(Wd.lineNumber=Number(rb[0]),Wd.columnNumber=Number(rb[1])):Wd.lineNumber=Number(rb[0]));var Pi={level:"ERROR_LEVEL_UNKNOWN",
...
;function qq(){if(ke()||Yj&&Zj("applewebkit")&&!Zj("version")&&(!Zj("safari")||Zj("gsa/"))||vc&&Zj("version/"))return!0;if(M("enable_web_eom_visitor_data"))return A("EOM_VISITOR_DATA")?!1:!0;var a=A("INNERTUBE_CLIENT_NAME");return!a||"WEB"!==a&&"MWEB"!==a?!0:(a=kj("CONSENT"))?a.startsWith("YES+"):!0}
...
Tr.prototype.tick=function(a,b,c,d){Vr(this,"tick_"+a+"_"+b)||(c={timestamp:c,cttAuthInfo:d},M("web_csi_via_jspb")?(d=new wh,D(d,1,a),D(d,2,b),a=new zh,nd(a,5,Ah,d),xp(a,c)):ik("latencyActionTicked",{tickName:a,clientActionNonce:b},c))};
...
Tr.prototype.jspbInfo=function(a,b,c){for(var d="",e=0;e<a.toJSON().length;e++)void 0!==a.toJSON()[e]&&(d=0===e?d.concat(""+e):d.concat("_"+e));Vr(this,"info_"+d+"_"+b)||(D(a,2,b),b={cttAuthInfo:c},c=new zh,nd(c,7,Ah,a),xp(c,b))};
...
var gs=window;gs.ytcsi&&(gs.ytcsi.info=Zr,gs.ytcsi.tick=Z);var hs=["consistency","mss","client_location","entities","store"];function is(a,b,c,d){this.o=a;this.J=b;this.l=c;this.j=d;this.i=void 0;this.h=new Map;a.za||(a.za={});a.za=Object.assign({},ar,a.za)}
...
X:b};d=p(d);for(var g=d.next();!g.done;g=d.next())g=g.value.getAsJson(),(ob(g)||!g.trackingParams&&!g.veType)&&Lp(Error("Child VE logged with no data"));if(M("il_via_jspb")){var h=new ih;h.S(b);kh(h,c.getAsJspb());gb(e,function(k){k=k.getAsJspb();od(h,3,ch,k)});
...
d,f)));a.h[a.h.length-1]&&!a.h[a.h.length-1].csn&&(a.h[a.h.length-1].csn=k||"");Yr({clientScreenNonce:k});Ls.getInstance().clear();d=aq(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(M("web_mark_root_visible")||M("music_web_mark_root_visible"))&&(e={cttAuthInfo:eq(k),X:k},M("il_via_jspb")?(b=new mh,b.S(k),f=d.getAsJspb(),H(b,2,f),D(b,4,1),"UNDEFINED_CSN"==k?Ks("visualElementShown",b,e):(k=new zh,nd(k,72,Ah,b),xp(k,e))):(b={csn:k,ve:d.getAsJson(),eventType:1},"UNDEFINED_CSN"==k?Ks("visualElementShown",b,e):
...
function ot(a,b,c,d){d=void 0===d?null:d;var e=Kd("SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
...
try{kt("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}rt.push(af.N(function(){if(!(st||"google_ad_status"in window)){try{qt("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}st=!0;Wh("DCLKSTAT",3)}},5E3))}}
...
function wt(a,b,c,d,e,f){var g=void 0===g?"trayride":g;c?(a.state=2,kt(c,function(){window[g]?At(a,d,g,e):(a.state=3,pt(c),Lp(new Q("Unable to load Botguard","from "+c)))},f)):b?(f=Kd("SCRIPT"),f.textContent=b,f.nonce=Xb(),document.head.appendChild(f),document.head.removeChild(f),window[g]?At(a,d,g,e):(a.state=4,Lp(new Q("Unable to load Botguard from JS")))):Lp(new Q("Unable to load VM; no url or JS provided"))}
l.isInitialized=function(){return!!this.h};
l.getState=function(){return this.state};
function At(a,b,c,d){a.state=5;try{var e=new zd({program:b,globalName:c});e.vc.then(function(){a.state=6;d&&d(b)});
...
function Bt(a,b){oe(a.h);a.h=b}
;var Ct=new vt;function Dt(){return Ct.isInitialized()}
function Et(a){a=void 0===a?{}:a;return Ct.invoke(a)}
;function Ft(a){var b=this;var c=void 0===c?0:c;var d=void 0===d?Xj():d;this.l=c;this.j=d;this.i=new yd;this.h=a;a={};c=p(this.h.entries());for(d=c.next();!d.done;a={sa:a.sa,Ba:a.Ba},d=c.next()){var e=p(d.value);d=e.next().value;e=e.next().value;a.Ba=d;a.sa=e;d=function(f){return function(){f.sa.cb();b.h[f.Ba].Ra=!0;b.h.every(function(g){return!0===g.Ra})&&b.i.resolve()}}(a);
...
var Ot;r(Nt,Mt);Nt.prototype.l=function(){if(M("web_fp_via_jspb")){var a=new bh,b=cq();b&&a.S(b);b=new zh;nd(b,380,Ah,a);xp(b);M("web_fp_via_jspb_and_json")&&ik("finalPayload",{csn:cq()})}else ik("finalPayload",{csn:cq()})};
...
hu.prototype.I=function(){eu.prototype.I.call(this);delete this.api};function iu(a){a=void 0===a?!1:a;K.call(this);this.i=new L(a);qe(this,Xa(oe,this.i))}
...
ju.prototype.I=function(){this.destination=this.j=null;iu.prototype.I.call(this)};function ku(a,b,c){K.call(this);this.destination=a;this.origin=c;this.i=xn(window,"message",this.j.bind(this));this.connection=new ju(this,a,b);qe(this,Xa(oe,this.connection))}
...
function pu(a){var b=Kd("A");Cb("This URL is never added to the DOM");Ub(b,new Mb(a,Nb));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Zb(a)}
...
r(su,ru);function tu(a,b,c,d){K.call(this);var e=this;this.M=b;this.webPlayerContextConfig=d;this.Ta=!1;this.api={};this.Da=this.u=null;this.T=new L;this.i={};this.fa=this.Ea=this.elementId=this.Ua=this.config=null;this.Y=!1;this.l=this.A=null;this.Fa={};this.Lb=["onReady"];this.lastError=null;this.kb=NaN;this.L={};this.Mb=new su(this);this.na=0;this.j=this.m=a;qe(this,Xa(oe,this.T));uu(this);vu(this);qe(this,Xa(oe,this.Mb));c?this.na=yi(function(){e.loadNewVideoConfig(c)},0):d&&(wu(this),xu(this))}
...
function Cu(a){var b=Jd(a.elementId);!b&&a.j&&a.j.querySelector&&(b=a.j.querySelector("#"+a.elementId));return b}
...
Uu(d,b,h)}else Uu(d,b)}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var k=void 0===k?{}:k;var m=void 0===m?"":m;var q=void 0===q?window:q;c=q.location;a=gc(a,k)+m;var u=void 0===u?Ud:u;a:{u=void 0===u?Ud:u;for(k=0;k<u.length;++k)if(m=u[k],m instanceof Sd&&m.isValid(a)){u=new Dd(a,Bd);break a}u=void 0}c.href=Fd(u||Ed)}return!0}
...
A("PL_ATT")&&Ct.dispose();for(var a=af,b=0,c=rt.length;b<c;b++)a.U(rt[b]);rt.length=0;pt("//static.doubleclick.net/instream/ad_status.js");st=!1;Wh("DCLKSTAT",0);pe(Su,Ru);Qu&&(Qu.removeEventListener("onVideoDataChange",Tu),Qu.destroy())});
